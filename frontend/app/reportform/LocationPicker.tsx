...
import type { GeoLocation } from "@/app/lib/types";
...
const pinIcon = L.divIcon({
  ...
  html: `<svg width="34" height="44" viewBox="0 0 34 44" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 0C7.6 0 0 7.6 0 17c0 12.7 17 27 17 27s17-14.3 17-27C34 7.6 26.4 0 17 0z" fill="#1B3A4B"/>
    <circle cx="17" cy="17" r="7" fill="#F2A93C"/>
  </svg>`,
  iconSize: [34, 44],
  iconAnchor: [17, 44],
});
